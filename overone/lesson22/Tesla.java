...
public class Tesla extends Car {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Tesla)) return false;
        if (!super.equals(o)) return false;
        Tesla tesla = (Tesla) o;
        return yearOfCarProduction == tesla.yearOfCarProduction && Objects.equals(brand, tesla.brand) && Objects.equals(model, tesla.model) && Objects.equals(color, tesla.color);
    }
